...
import { createNorma, searchNormas, updateNorma, getNormaDocumento, getNormaByCode, getNormasRelacionadas, addNormaRelacionada, removeNormaRelacionada, createNormaRevisao } from "../controllers/norma.controller";
...
router.post("/:codigo/revisao", authMiddleware, roleMiddleware(["ADMIN"]), handleUpload, createNormaRevisao);
