...
| :---------: | :---------: | :---------: | :---------: | :---------: |
| 🎗  1 | Alta | Como Administrador, quero cadastrar normas no sistema... | 8 | 1 |
| 🎗  2 | Alta | Como Visualizador, quero acessar a plataforma no cargo de leitor... | 7 | 1 |
| 🎗  3 | Alta | Como Administrador, quero realizar login seguro na plataforma... | 6 | 1 |
| 🎗  4 | Alta | Como Visualizador, quero pesquisar normas por palavras-chave... | 10 | 1 |
| 🎗  5 | Alta | Como Visualizador, quero filtrar as normas por órgão emissor... | 10 | 1 |
| 🎗  6 | Alta | Como Administrador, quero atualizar uma norma com sua revisão... | 7 | 2 |
| 🎗  7 | Alta | Como Visualizador, quero ler o documento original... | 3 | 2 |
| 🎗  8 | Alta | Como Administrador, quero correlacionar normas e requisitos... | 10 | 2 |
| 🎗  9 | Média | Como Administrador, quero adicionar contexto normativo... | 10 | 2 |
| 🎗  10 | Média | Como Visualizador, quero visualizar a página da norma... | 5 | 2 |
| 🎗  11 | Média | Como Administrador, quero editar os dados de uma norma... | 5 | 3 |
| 🎗  12 | Média | Como Administrador, quero cadastrar novos usuários... | 5 | 3 |
| 🎗  13 | Média | Como Visualizador, quero acessar o histórico de revisões... | 7 | 3 |
| 🎗  14 | Média | Como Administrador, quero editar os dados e acesso... | 5 | 3 |
| 🎗  15 | Média | Como Administrador, quero remover usuários do sistema... | 4 | 3 |
| 🎗  16 | Baixa | Como Administrador, quero ver o registro de edição... | 5 | 3 |
