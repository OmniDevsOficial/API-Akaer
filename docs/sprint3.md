...
| :---: | :--- | 
| 🥇 |**US-10:** Como Visualizador, quero enviar uma solicitação, relacionada a uma norma, para que o Técnico ou Administrador possa avaliar e dar andamento ao pedido. |
| 🥈 |**US-11:** Como Checker, quero aprovar os pedidos de implementação de novas normas e notas para validar o conteúdo técnico antes que ele seja efetivamente cadastrado na plataforma. |


## Sprint 3 <a id="sprint-3"></a>
